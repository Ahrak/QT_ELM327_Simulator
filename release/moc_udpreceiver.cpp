...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_UDPReceiver_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 50, 10)
    ...
    "UDPReceiver\0readPendingDatagrams\0\0"
    "connect\0ip\0port\0disconnect\0"
};
...
void UDPReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->connect((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
...
const QMetaObject UDPReceiver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UDPReceiver.data,
      qt_meta_data_UDPReceiver,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UDPReceiver.stringdata))
